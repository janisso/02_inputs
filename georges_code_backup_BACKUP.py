...
if __name__ == '__main__':
    ...
    p0.start()
    p0.join()
    os.system('open /Users/mb/Desktop/Janis.so/06_qmul/BB/02_inputs/inscore_stuff/main_menu/lalaland.inscore')
    os.system('open -a Terminal')
    ...
    for j in range(1,7):
        ...
        oscSendI('/ITL/scene/demoText',['set','txt', 'Begin Practicing '+str(j)])
        ...
        p0.start()
        p0.join()
        os.system('open /Users/mb/Desktop/Janis.so/06_qmul/BB/02_inputs/inscore_stuff/main_menu/excerpt_'+str(j)+'_xml.inscore')
        os.system('open -a Terminal')
        for i in range(3,0,-1):
            oscSendI('/ITL/scene/demoText1',['set', 'txt', i])
            print 'Play in '+str(i)
